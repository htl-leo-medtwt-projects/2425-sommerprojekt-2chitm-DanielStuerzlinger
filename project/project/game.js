...
var myFont = new FontFace('exo', 'url(../font/Exo-Regular.ttf)');
...
function gameInitiate() {
  ...
  function purchaseUpgrade(key) {
    ...
    if (ship.score >= up.cost) {
      ship.score -= up.cost;
      up.level++;
      up.cost = Math.min(Math.round(up.cost * 1.3 / 10) * 10, 5000);
      applyUpgradeEffects();
    }
  }
  ...
  function update() {
    ...
    // Kollisionsabfrage Schiff - Asteroiden
